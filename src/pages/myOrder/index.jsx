...
import { getMyOrderList, updateOrderStatus } from "../../api/order";
...
const MyOrder = () => {
    ...
    // 获取订单列表
    const { run: getMyOrderListFn, loading } = useRequest(getMyOrderList, {
        manual: true,
        onSuccess: (res) => {
            if (page === 1) {
    ...
    useDidShow(() => {
        const storedStatus = Taro.getStorageSync('myOrderStatus')
